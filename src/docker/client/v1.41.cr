...
module Docker
  ...
  class Client
    def container_list(*, all : Bool? = nil, limit : Int64? = nil, size : Bool? = nil, filters : String? = nil) : Array(ContainerSummary)
      ...
      http_client.get("/v1.41/containers/json?#{query}") do |response|
    ...
    def container_create(body : ContainerCreate, *, name : String? = nil, platform : String? = nil) : ContainerCreateResponse
      ...
      http_client.post("/v1.41/containers/create?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 201
    ...
    def container_inspect?(id : String, *, size : Bool? = nil) : ContainerInspectResponse?
      ...
      http_client.get("/v1.41/containers/#{URI.encode_path_segment(id)}/json?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def container_top?(id : String, *, ps_args : String? = nil) : ContainerTopResponse?
      ...
      http_client.get("/v1.41/containers/#{URI.encode_path_segment(id)}/top?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def container_logs?(id : String, *, follow : Bool? = nil, stdout : Bool? = nil, stderr : Bool? = nil, since : Int64? = nil, _until : Int64? = nil, timestamps : Bool? = nil, tail : String? = nil) : Bytes?
      ...
      http_client.get("/v1.41/containers/#{URI.encode_path_segment(id)}/logs?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def container_changes?(id : String) : Array(ContainerChangeResponseItem)?
      http_client.get("/v1.41/containers/#{URI.encode_path_segment(id)}/changes") do |response|
        case response.status_code
        when 200
    ...
    def container_export?(id : String) : Nil
      http_client.get("/v1.41/containers/#{URI.encode_path_segment(id)}/export") do |response|
        case response.status_code
        when 200, 404
        when 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_stats?(id : String, *, stream : Bool? = nil, one_shot : Bool? = nil) : JSON::Any?
      ...
      http_client.get("/v1.41/containers/#{URI.encode_path_segment(id)}/stats?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def container_resize(id : String, *, h : Int64? = nil, w : Int64? = nil) : Nil
      ...
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/resize?#{query}") do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_start(id : String, *, detach_keys : String? = nil) : Nil
      ...
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/start?#{query}") do |response|
        case response.status_code
        when 204, 304
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_stop(id : String, *, t : Int64? = nil) : Nil
      ...
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/stop?#{query}") do |response|
        case response.status_code
        when 204, 304
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_restart(id : String, *, t : Int64? = nil) : Nil
      ...
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/restart?#{query}") do |response|
        case response.status_code
        when 204
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_kill(id : String, *, signal : String? = nil) : Nil
      ...
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/kill?#{query}") do |response|
        case response.status_code
        when 204
        when 404, 409, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_update(id : String, update : ContainerUpdate) : ContainerUpdateResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/update", headers: headers, body: update.to_json) do |response|
        case response.status_code
        when 200
    ...
    def container_rename(id : String, *, name : String) : Nil
      ...
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/rename?#{query}") do |response|
        case response.status_code
        when 204
        when 404, 409, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_pause(id : String) : Nil
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/pause") do |response|
        case response.status_code
        when 204
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_unpause(id : String) : Nil
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/unpause") do |response|
        case response.status_code
        when 204
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_attach(id : String, *, detach_keys : String? = nil, logs : Bool? = nil, stream : Bool? = nil, stdin : Bool? = nil, stdout : Bool? = nil, stderr : Bool? = nil) : Nil
      ...
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/attach?#{query}") do |response|
        case response.status_code
        when 101, 200
        when 400, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_attach_websocket?(id : String, *, detach_keys : String? = nil, logs : Bool? = nil, stream : Bool? = nil) : Nil
      ...
      http_client.get("/v1.41/containers/#{URI.encode_path_segment(id)}/attach/ws?#{query}") do |response|
        case response.status_code
        when 101, 200, 404
        when 400, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_wait(id : String, *, condition : String? = nil) : ContainerWaitResponse
      ...
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/wait?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def container_delete(id : String, *, v : Bool? = nil, force : Bool? = nil, link : Bool? = nil) : Nil
      ...
      http_client.delete("/v1.41/containers/#{URI.encode_path_segment(id)}?#{query}") do |response|
        case response.status_code
        when 204
        when 400, 404, 409, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_archive?(id : String, *, path : String) : Nil
      ...
      http_client.get("/v1.41/containers/#{URI.encode_path_segment(id)}/archive?#{query}") do |response|
        case response.status_code
        when 200, 404
        when 400, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def put_container_archive(id : String, input_stream : Bytes, *, path : String, no_overwrite_dir_non_dir : String? = nil, copy_uidgid : String? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.put("/v1.41/containers/#{URI.encode_path_segment(id)}/archive?#{query}", headers: headers, body: input_stream.to_json) do |response|
        case response.status_code
        when 200
    ...
    def container_archive_info(id : String, *, path : String) : Nil
      ...
      http_client.head("/v1.41/containers/#{URI.encode_path_segment(id)}/archive?#{query}") do |response|
        case response.status_code
        when 200
        when 400, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_prune(*, filters : String? = nil) : ContainerPruneResponse
      ...
      http_client.post("/v1.41/containers/prune?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_list(*, all : Bool? = nil, filters : String? = nil, digests : Bool? = nil) : Array(ImageSummary)
      ...
      http_client.get("/v1.41/images/json?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_build(input_stream : Bytes? = nil, *, dockerfile : String? = nil, t : String? = nil, extrahosts : String? = nil, remote : String? = nil, q : Bool? = nil, nocache : Bool? = nil, cachefrom : String? = nil, pull : String? = nil, rm : Bool? = nil, forcerm : Bool? = nil, memory : Int64? = nil, memswap : Int64? = nil, cpushares : Int64? = nil, cpusetcpus : String? = nil, cpuperiod : Int64? = nil, cpuquota : Int64? = nil, buildargs : String? = nil, shmsize : Int64? = nil, squash : Bool? = nil, labels : String? = nil, networkmode : String? = nil, platform : String? = nil, target : String? = nil, outputs : String? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/build?#{query}", headers: headers, body: input_stream.to_json) do |response|
        case response.status_code
        when 200
        when 400, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def build_prune(*, keep_storage : Int64? = nil, all : Bool? = nil, filters : String? = nil) : BuildPruneResponse
      ...
      http_client.post("/v1.41/build/prune?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_create(input_image : String? = nil, *, from_image : String? = nil, from_src : String? = nil, repo : String? = nil, tag : String? = nil, message : String? = nil, changes : Array(String)? = nil, platform : String? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/images/create?#{query}", headers: headers, body: input_image.to_json) do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def image_inspect?(name : String) : ImageInspect?
      http_client.get("/v1.41/images/#{URI.encode_path_segment(name)}/json") do |response|
        case response.status_code
        when 200
    ...
    def image_history?(name : String) : Array(HistoryResponseItem)?
      http_client.get("/v1.41/images/#{URI.encode_path_segment(name)}/history") do |response|
        case response.status_code
        when 200
    ...
    def image_push(name : String, *, tag : String? = nil) : Nil
      ...
      http_client.post("/v1.41/images/#{URI.encode_path_segment(name)}/push?#{query}") do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def image_tag(name : String, *, repo : String? = nil, tag : String? = nil) : Nil
      ...
      http_client.post("/v1.41/images/#{URI.encode_path_segment(name)}/tag?#{query}") do |response|
        case response.status_code
        when 201
        when 400, 404, 409, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def image_delete(name : String, *, force : Bool? = nil, noprune : Bool? = nil) : Array(ImageDeleteResponseItem)
      ...
      http_client.delete("/v1.41/images/#{URI.encode_path_segment(name)}?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_search(*, term : String, limit : Int64? = nil, filters : String? = nil) : Array(ImageSearchResponseItem)
      ...
      http_client.get("/v1.41/images/search?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_prune(*, filters : String? = nil) : ImagePruneResponse
      ...
      http_client.post("/v1.41/images/prune?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def system_auth(auth_config : AuthConfig? = nil) : SystemAuthResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/auth", headers: headers, body: auth_config.to_json) do |response|
        case response.status_code
        when 200
    ...
    def system_info() : SystemInfo
      http_client.get("/v1.41/info") do |response|
        case response.status_code
        when 200
    ...
    def system_version() : SystemVersion
      http_client.get("/v1.41/version") do |response|
        case response.status_code
        when 200
    ...
    def system_ping() : String
      http_client.get("/v1.41/_ping") do |response|
        case response.status_code
        when 200
    ...
    def system_ping_head() : String
      http_client.head("/v1.41/_ping") do |response|
        case response.status_code
        when 200
          String.from_json(response.body_io)
        when 500
    ...
    def image_commit(container_config : ContainerConfig? = nil, *, container : String? = nil, repo : String? = nil, tag : String? = nil, comment : String? = nil, author : String? = nil, pause : Bool? = nil, changes : String? = nil) : IdResponse
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/commit?#{query}", headers: headers, body: container_config.to_json) do |response|
        case response.status_code
        when 201
    ...
    def system_events(*, since : String? = nil, _until : String? = nil, filters : String? = nil) : EventMessage
      ...
      http_client.get("/v1.41/events?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def system_data_usage() : SystemDataUsageResponse
      http_client.get("/v1.41/system/df") do |response|
        case response.status_code
        when 200
    ...
    def image_get(name : String) : Bytes
      http_client.get("/v1.41/images/#{URI.encode_path_segment(name)}/get") do |response|
        case response.status_code
        when 200
          yield response.body_io
        when 500
    ...
    def image_get_all(*, names : Array(String)? = nil) : Bytes
      ...
      http_client.get("/v1.41/images/get?#{query}") do |response|
        case response.status_code
        when 200
          yield response.body_io
        when 500
    ...
    def image_load(images_tarball : Bytes? = nil, *, quiet : Bool? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/images/load?#{query}", headers: headers, body: images_tarball.to_json) do |response|
        case response.status_code
        when 200
        when 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_exec(id : String, exec_config : ExecConfig) : IdResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/containers/#{URI.encode_path_segment(id)}/exec", headers: headers, body: exec_config.to_json) do |response|
        case response.status_code
        when 201
          IdResponse.from_json(response.body_io)
        when 404, 409, 500
    ...
    def exec_start(id : String, exec_start_config : ExecStartConfig? = nil) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/exec/#{URI.encode_path_segment(id)}/start", headers: headers, body: exec_start_config.to_json) do |response|
        case response.status_code
        when 200
        when 404, 409
          raise ErrorResponse.from_json(response.body_io)
    ...
    def exec_resize(id : String, *, h : Int64? = nil, w : Int64? = nil) : Nil
      ...
      http_client.post("/v1.41/exec/#{URI.encode_path_segment(id)}/resize?#{query}") do |response|
        case response.status_code
        when 200
        when 400, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def exec_inspect?(id : String) : ExecInspectResponse?
      http_client.get("/v1.41/exec/#{URI.encode_path_segment(id)}/json") do |response|
        case response.status_code
        when 200
    ...
    def volume_list(*, filters : String? = nil) : VolumeListResponse
      ...
      http_client.get("/v1.41/volumes?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def volume_create(volume_config : VolumeCreateOptions) : Volume
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/volumes/create", headers: headers, body: volume_config.to_json) do |response|
        case response.status_code
        when 201
    ...
    def volume_inspect?(name : String) : Volume?
      http_client.get("/v1.41/volumes/#{URI.encode_path_segment(name)}") do |response|
        case response.status_code
        when 200
          Volume.from_json(response.body_io)
        when 404
    ...
    def volume_delete(name : String, *, force : Bool? = nil) : Nil
      ...
      http_client.delete("/v1.41/volumes/#{URI.encode_path_segment(name)}?#{query}") do |response|
        case response.status_code
        when 204
        when 404, 409, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def volume_prune(*, filters : String? = nil) : VolumePruneResponse
      ...
      http_client.post("/v1.41/volumes/prune?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def network_list(*, filters : String? = nil) : Array(Network)
      ...
      http_client.get("/v1.41/networks?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def network_inspect?(id : String, *, verbose : Bool? = nil, scope : String? = nil) : Network?
      ...
      http_client.get("/v1.41/networks/#{URI.encode_path_segment(id)}?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def network_delete(id : String) : Nil
      http_client.delete("/v1.41/networks/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 204
        when 403, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def network_create(network_config : NetworkCreateRequest) : NetworkCreateResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/networks/create", headers: headers, body: network_config.to_json) do |response|
        case response.status_code
        when 201
    ...
    def network_connect(id : String, container : NetworkConnectRequest) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/networks/#{URI.encode_path_segment(id)}/connect", headers: headers, body: container.to_json) do |response|
        case response.status_code
        when 200
        when 403, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def network_disconnect(id : String, container : NetworkDisconnectRequest) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/networks/#{URI.encode_path_segment(id)}/disconnect", headers: headers, body: container.to_json) do |response|
        case response.status_code
        when 200
        when 403, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def network_prune(*, filters : String? = nil) : NetworkPruneResponse
      ...
      http_client.post("/v1.41/networks/prune?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def plugin_list(*, filters : String? = nil) : Array(Plugin)
      ...
      http_client.get("/v1.41/plugins?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def get_plugin_privileges(*, remote : String) : Array(PluginPrivilege)
      ...
      http_client.get("/v1.41/plugins/privileges?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def plugin_pull(body : Array(PluginPrivilege)? = nil, *, remote : String, name : String? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/plugins/pull?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 204
        when 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_inspect?(name : String) : Plugin?
      http_client.get("/v1.41/plugins/#{URI.encode_path_segment(name)}/json") do |response|
        case response.status_code
        when 200
    ...
    def plugin_delete(name : String, *, force : Bool? = nil) : Plugin
      ...
      http_client.delete("/v1.41/plugins/#{URI.encode_path_segment(name)}?#{query}") do |response|
        case response.status_code
        when 200
          Plugin.from_json(response.body_io)
        when 404, 500
    ...
    def plugin_enable(name : String, *, timeout : Int64? = nil) : Nil
      ...
      http_client.post("/v1.41/plugins/#{URI.encode_path_segment(name)}/enable?#{query}") do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_disable(name : String) : Nil
      http_client.post("/v1.41/plugins/#{URI.encode_path_segment(name)}/disable") do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_upgrade(name : String, body : Array(PluginPrivilege)? = nil, *, remote : String) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/plugins/#{URI.encode_path_segment(name)}/upgrade?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 204
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_create(tar_context : Bytes? = nil, *, name : String) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/plugins/create?#{query}", headers: headers, body: tar_context.to_json) do |response|
        case response.status_code
        when 204
        when 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_push(name : String) : Nil
      http_client.post("/v1.41/plugins/#{URI.encode_path_segment(name)}/push") do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_set(name : String, body : Array(String)? = nil) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/plugins/#{URI.encode_path_segment(name)}/set", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 204
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def node_list(*, filters : String? = nil) : Array(Node)
      ...
      http_client.get("/v1.41/nodes?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def node_inspect?(id : String) : Node?
      http_client.get("/v1.41/nodes/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 200
    ...
    def node_delete(id : String, *, force : Bool? = nil) : Nil
      ...
      http_client.delete("/v1.41/nodes/#{URI.encode_path_segment(id)}?#{query}") do |response|
        case response.status_code
        when 200
        when 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def node_update(id : String, body : NodeSpec? = nil, *, version : Int64) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/nodes/#{URI.encode_path_segment(id)}/update?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
    ...
    def swarm_inspect?() : Swarm?
      http_client.get("/v1.41/swarm") do |response|
        case response.status_code
        when 200
    ...
    def swarm_init(body : SwarmInitRequest) : String
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/swarm/init", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
          String.from_json(response.body_io)
        when 400, 500, 503
    ...
    def swarm_join(body : SwarmJoinRequest) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/swarm/join", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 400, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def swarm_leave(*, force : Bool? = nil) : Nil
      ...
      http_client.post("/v1.41/swarm/leave?#{query}") do |response|
        case response.status_code
        when 200
        when 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def swarm_update(body : SwarmSpec, *, version : Int64, rotate_worker_token : Bool? = nil, rotate_manager_token : Bool? = nil, rotate_manager_unlock_key : Bool? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/swarm/update?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 400, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def swarm_unlockkey() : UnlockKeyResponse
      http_client.get("/v1.41/swarm/unlockkey") do |response|
        case response.status_code
        when 200
    ...
    def swarm_unlock(body : SwarmUnlockRequest) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/swarm/unlock", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def service_list(*, filters : String? = nil, status : Bool? = nil) : Array(Service)
      ...
      http_client.get("/v1.41/services?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def service_create(body : ServiceCreate) : ServiceCreateResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/services/create", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 201
    ...
    def service_inspect?(id : String, *, insert_defaults : Bool? = nil) : Service?
      ...
      http_client.get("/v1.41/services/#{URI.encode_path_segment(id)}?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def service_delete(id : String) : Nil
      http_client.delete("/v1.41/services/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 200
        when 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def service_update(id : String, body : ServiceUpdate, *, version : Int64, registry_auth_from : String? = nil, rollback : String? = nil) : ServiceUpdateResponse
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/services/#{URI.encode_path_segment(id)}/update?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
    ...
    def service_logs?(id : String, *, details : Bool? = nil, follow : Bool? = nil, stdout : Bool? = nil, stderr : Bool? = nil, since : Int64? = nil, timestamps : Bool? = nil, tail : String? = nil) : Bytes?
      ...
      http_client.get("/v1.41/services/#{URI.encode_path_segment(id)}/logs?#{query}") do |response|
        case response.status_code
        when 200
          yield response.body_io
        when 404
    ...
    def task_list(*, filters : String? = nil) : Array(Task)
      ...
      http_client.get("/v1.41/tasks?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def task_inspect?(id : String) : Task?
      http_client.get("/v1.41/tasks/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 200
    ...
    def task_logs?(id : String, *, details : Bool? = nil, follow : Bool? = nil, stdout : Bool? = nil, stderr : Bool? = nil, since : Int64? = nil, timestamps : Bool? = nil, tail : String? = nil) : Bytes?
      ...
      http_client.get("/v1.41/tasks/#{URI.encode_path_segment(id)}/logs?#{query}") do |response|
        case response.status_code
        when 200
          yield response.body_io
        when 404
    ...
    def secret_list(*, filters : String? = nil) : Array(Secret)
      ...
      http_client.get("/v1.41/secrets?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def secret_create(body : SecretCreate? = nil) : IdResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/secrets/create", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 201
          IdResponse.from_json(response.body_io)
        when 409, 500, 503
    ...
    def secret_inspect?(id : String) : Secret?
      http_client.get("/v1.41/secrets/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 200
    ...
    def secret_delete(id : String) : Nil
      http_client.delete("/v1.41/secrets/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 204
        when 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def secret_update(id : String, body : SecretSpec? = nil, *, version : Int64) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/secrets/#{URI.encode_path_segment(id)}/update?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 400, 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def config_list(*, filters : String? = nil) : Array(Config)
      ...
      http_client.get("/v1.41/configs?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def config_create(body : ConfigCreate? = nil) : IdResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/configs/create", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 201
          IdResponse.from_json(response.body_io)
        when 409, 500, 503
    ...
    def config_inspect?(id : String) : Config?
      http_client.get("/v1.41/configs/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 200
    ...
    def config_delete(id : String) : Nil
      http_client.delete("/v1.41/configs/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 204
        when 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def config_update(id : String, body : ConfigSpec? = nil, *, version : Int64) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.41/configs/#{URI.encode_path_segment(id)}/update?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 400, 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def distribution_inspect(name : String) : DistributionInspect
      http_client.get("/v1.41/distribution/#{URI.encode_path_segment(name)}/json") do |response|
        case response.status_code
        when 200
    ...
    def session() : Nil
      http_client.post("/v1.41/session") do |response|
        case response.status_code
        when 101
        when 400, 500
          raise ErrorResponse.from_json(response.body_io)
