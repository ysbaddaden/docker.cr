...
module Docker
  ...
  alias ChangeType = UInt8

  alias Topology = Hash(String, String)
  ...
  class BuildCache
    ...
    def initialize(@id : String? = nil, @parent : String? = nil, @parents : Array(String)? = nil, @type : String? = nil, @description : String? = nil, @in_use : Bool? = nil, @shared : Bool? = nil, @size : Int64? = nil, @created_at : Time? = nil, @last_used_at : Time? = nil, @usage_count : Int64? = nil)
    end
  end
  ...
  class ClusterVolume
    ...
    @[JSON::Field(key: "Spec")]
    property! spec : ClusterVolumeSpec?

    @[JSON::Field(key: "Info")]
    property! info : ClusterVolume::Info?

    @[JSON::Field(key: "PublishStatus")]
    property! publish_status : Array(ClusterVolume::PublishStatus)?

    def initialize(@id : String? = nil, @version : ObjectVersion? = nil, @created_at : Time? = nil, @updated_at : Time? = nil, @spec : ClusterVolumeSpec? = nil, @info : ClusterVolume::Info? = nil, @publish_status : Array(ClusterVolume::PublishStatus)? = nil)
    end
  end

  class ClusterVolume::Info
    include JSON::Serializable

    @[JSON::Field(key: "CapacityBytes")]
    property! capacity_bytes : Int64?

    @[JSON::Field(key: "VolumeContext")]
    property! volume_context : Hash(String, String)?

    @[JSON::Field(key: "VolumeID")]
    property! volume_id : String?

    @[JSON::Field(key: "AccessibleTopology")]
    property! accessible_topology : Array(Topology)?

    def initialize(@capacity_bytes : Int64? = nil, @volume_context : Hash(String, String)? = nil, @volume_id : String? = nil, @accessible_topology : Array(Topology)? = nil)
    end
  end

  class ClusterVolume::PublishStatus
    include JSON::Serializable
    ...
    @[JSON::Field(key: "PublishContext")]
    property! publish_context : Hash(String, String)?

    def initialize(@node_id : String? = nil, @state : String? = nil, @publish_context : Hash(String, String)? = nil)
    end
  end
  ...
  class ClusterVolumeSpec
    ...
    property! access_mode : ClusterVolumeSpec::AccessMode?

    def initialize(@group : String? = nil, @access_mode : ClusterVolumeSpec::AccessMode? = nil)
    end
  end

  class ClusterVolumeSpec::AccessMode
    include JSON::Serializable
    ...
    @[JSON::Field(key: "MountVolume")]
    property! mount_volume : ClusterVolumeSpec::AccessMode::MountVolume?

    @[JSON::Field(key: "Secrets")]
    property! secrets : Array(ClusterVolumeSpec::AccessMode::Secrets)?

    @[JSON::Field(key: "AccessibilityRequirements")]
    property! accessibility_requirements : ClusterVolumeSpec::AccessMode::AccessibilityRequirements?

    @[JSON::Field(key: "CapacityRange")]
    property! capacity_range : ClusterVolumeSpec::AccessMode::CapacityRange?

    @[JSON::Field(key: "Availability")]
    property! availability : String

    def initialize(@scope : String, @sharing : String, @availability : String, @mount_volume : ClusterVolumeSpec::AccessMode::MountVolume? = nil, @secrets : Array(ClusterVolumeSpec::AccessMode::Secrets)? = nil, @accessibility_requirements : ClusterVolumeSpec::AccessMode::AccessibilityRequirements? = nil, @capacity_range : ClusterVolumeSpec::AccessMode::CapacityRange? = nil)
    end
  end

  class ClusterVolumeSpec::AccessMode::AccessibilityRequirements
    include JSON::Serializable

    @[JSON::Field(key: "Requisite")]
    property! requisite : Array(Topology)?

    @[JSON::Field(key: "Preferred")]
    property! preferred : Array(Topology)?

    def initialize(@requisite : Array(Topology)? = nil, @preferred : Array(Topology)? = nil)
    end
  end

  class ClusterVolumeSpec::AccessMode::CapacityRange
    include JSON::Serializable

    @[JSON::Field(key: "RequiredBytes")]
    property! required_bytes : Int64?

    @[JSON::Field(key: "LimitBytes")]
    property! limit_bytes : Int64?

    def initialize(@required_bytes : Int64? = nil, @limit_bytes : Int64? = nil)
    end
  end

  class ClusterVolumeSpec::AccessMode::MountVolume
    include JSON::Serializable
  end

  class ClusterVolumeSpec::AccessMode::Secrets
    include JSON::Serializable
    ...
    def initialize(@key : String? = nil, @secret : String? = nil)
    end
  end
  ...
  class ExecConfig
    ...
    def initialize(@attach_stdin : Bool? = nil, @attach_stdout : Bool? = nil, @attach_stderr : Bool? = nil, @console_size : Array(Int64)? = nil, @detach_keys : String? = nil, @tty : Bool? = nil, @env : Array(String)? = nil, @cmd : Array(String)? = nil, @privileged : Bool? = nil, @user : String? = nil, @working_dir : String? = nil)
    end
  end
  ...
  class ExecStartConfig
    ...
    def initialize(@detach : Bool? = nil, @tty : Bool? = nil, @console_size : Array(Int64)? = nil)
    end
  end
  ...
  class FilesystemChange
    ...
    @[JSON::Field(key: "Kind")]
    property! kind : ChangeType

    def initialize(@path : String, @kind : ChangeType)
    end
  end
  ...
  class HostConfig
    ...
    def initialize(@cpu_shares : Int64? = nil, @memory : Int64? = nil, @cgroup_parent : String? = nil, @blkio_weight : Int64? = nil, @blkio_weight_device : Array(HostConfig::BlkioWeightDevice)? = nil, @blkio_device_read_bps : Array(ThrottleDevice)? = nil, @blkio_device_write_bps : Array(ThrottleDevice)? = nil, @blkio_device_read_i_ops : Array(ThrottleDevice)? = nil, @blkio_device_write_i_ops : Array(ThrottleDevice)? = nil, @cpu_period : Int64? = nil, @cpu_quota : Int64? = nil, @cpu_realtime_period : Int64? = nil, @cpu_realtime_runtime : Int64? = nil, @cpuset_cpus : String? = nil, @cpuset_mems : String? = nil, @devices : Array(DeviceMapping)? = nil, @device_cgroup_rules : Array(String)? = nil, @device_requests : Array(DeviceRequest)? = nil, @kernel_memory_tcp : Int64? = nil, @memory_reservation : Int64? = nil, @memory_swap : Int64? = nil, @memory_swappiness : Int64? = nil, @nano_cpus : Int64? = nil, @oom_kill_disable : Bool? = nil, @init : Bool? = nil, @pids_limit : Int64? = nil, @ulimits : Array(HostConfig::Ulimits)? = nil, @cpu_count : Int64? = nil, @cpu_percent : Int64? = nil, @io_maximum_i_ops : Int64? = nil, @io_maximum_bandwidth : Int64? = nil, @binds : Array(String)? = nil, @container_id_file : String? = nil, @log_config : HostConfig::LogConfig? = nil, @network_mode : String? = nil, @port_bindings : PortMap? = nil, @restart_policy : RestartPolicy? = nil, @auto_remove : Bool? = nil, @volume_driver : String? = nil, @volumes_from : Array(String)? = nil, @mounts : Array(Mount)? = nil, @console_size : Array(Int64)? = nil, @annotations : Hash(String, String)? = nil, @cap_add : Array(String)? = nil, @cap_drop : Array(String)? = nil, @cgroupns_mode : String? = nil, @dns : Array(String)? = nil, @dns_options : Array(String)? = nil, @dns_search : Array(String)? = nil, @extra_hosts : Array(String)? = nil, @group_add : Array(String)? = nil, @ipc_mode : String? = nil, @cgroup : String? = nil, @links : Array(String)? = nil, @oom_score_adj : Int64? = nil, @pid_mode : String? = nil, @privileged : Bool? = nil, @publish_all_ports : Bool? = nil, @readonly_rootfs : Bool? = nil, @security_opt : Array(String)? = nil, @storage_opt : Hash(String, String)? = nil, @tmpfs : Hash(String, String)? = nil, @uts_mode : String? = nil, @userns_mode : String? = nil, @shm_size : Int64? = nil, @sysctls : Hash(String, String)? = nil, @runtime : String? = nil, @isolation : String? = nil, @masked_paths : Array(String)? = nil, @readonly_paths : Array(String)? = nil)
    end
  end
  ...
  class IPAM
    ...
    def initialize(@driver : String? = nil, @config : Array(IPAMConfig)? = nil, @options : Hash(String, String)? = nil)
    end
  end
  ...
  class IPAMConfig
    ...
    def initialize(@subnet : String? = nil, @ip_range : String? = nil, @gateway : String? = nil, @auxiliary_addresses : Hash(String, String)? = nil)
    end
  end
  ...
  class ImageInspect
    ...
    def initialize(@id : String, @parent : String, @comment : String, @created : String, @container : String, @docker_version : String, @author : String, @architecture : String, @os : String, @size : Int64, @repo_tags : Array(String)? = nil, @repo_digests : Array(String)? = nil, @container_config : ContainerConfig? = nil, @config : ContainerConfig? = nil, @variant : String? = nil, @os_version : String? = nil, @virtual_size : Int64? = nil, @graph_driver : GraphDriverData? = nil, @root_fs : ImageInspect::RootFS? = nil, @metadata : ImageInspect::Metadata? = nil)
    end
  end
  ...
  class ImageSummary
    ...
    def initialize(@id : String, @parent_id : String, @repo_tags : Array(String), @repo_digests : Array(String), @created : Int64, @size : Int64, @shared_size : Int64, @labels : Hash(String, String), @containers : Int64, @virtual_size : Int64? = nil)
    end
  end
  ...
  class Limit
    ...
    def initialize(@nano_cp_us : Int64? = nil, @memory_bytes : Int64? = nil, @pids : Int64? = nil)
    end
  end
  ...
  class Mount::BindOptions
    ...
    @[JSON::Field(key: "CreateMountpoint")]
    property! create_mountpoint : Bool?

    def initialize(@propagation : String? = nil, @non_recursive : Bool? = nil, @create_mountpoint : Bool? = nil)
    end
  end
  ...
  class Service
    ...
    property! service_status : Service::ServiceStatus?
  ...
  class Service::JobStatus
    include JSON::Serializable

    @[JSON::Field(key: "JobIteration")]
    property! job_iteration : ObjectVersion?

    @[JSON::Field(key: "LastExecution")]
    property! last_execution : Time?

    def initialize(@job_iteration : ObjectVersion? = nil, @last_execution : Time? = nil)
    end
  end

  class Service::ServiceStatus
    include JSON::Serializable

    @[JSON::Field(key: "RunningTasks")]
    property! running_tasks : UInt64?

    @[JSON::Field(key: "DesiredTasks")]
    property! desired_tasks : UInt64?

    @[JSON::Field(key: "CompletedTasks")]
    property! completed_tasks : UInt64?

    def initialize(@running_tasks : UInt64? = nil, @desired_tasks : UInt64? = nil, @completed_tasks : UInt64? = nil)
    end
  end
  ...
  class ServiceCreate::Mode
    ...
    @[JSON::Field(key: "ReplicatedJob")]
    property! replicated_job : ServiceCreate::Mode::ReplicatedJob?

    @[JSON::Field(key: "GlobalJob")]
    property! global_job : ServiceCreate::Mode::GlobalJob?

    def initialize(@replicated : ServiceCreate::Mode::Replicated? = nil, @global : ServiceCreate::Mode::Global? = nil, @replicated_job : ServiceCreate::Mode::ReplicatedJob? = nil, @global_job : ServiceCreate::Mode::GlobalJob? = nil)
    end
  end
  ...
  class ServiceCreate::Mode::GlobalJob
    include JSON::Serializable
  end
  ...
  class ServiceCreate::Mode::ReplicatedJob
    include JSON::Serializable

    @[JSON::Field(key: "MaxConcurrent")]
    property! max_concurrent : Int64?

    @[JSON::Field(key: "TotalCompletions")]
    property! total_completions : Int64?

    def initialize(@max_concurrent : Int64? = nil, @total_completions : Int64? = nil)
    end
  end
  ...
  class ServiceSpec::Mode
    ...
    @[JSON::Field(key: "ReplicatedJob")]
    property! replicated_job : ServiceSpec::Mode::ReplicatedJob?

    @[JSON::Field(key: "GlobalJob")]
    property! global_job : ServiceSpec::Mode::GlobalJob?

    def initialize(@replicated : ServiceSpec::Mode::Replicated? = nil, @global : ServiceSpec::Mode::Global? = nil, @replicated_job : ServiceSpec::Mode::ReplicatedJob? = nil, @global_job : ServiceSpec::Mode::GlobalJob? = nil)
    end
  end
  ...
  class ServiceSpec::Mode::GlobalJob
    include JSON::Serializable
  end
  ...
  class ServiceSpec::Mode::ReplicatedJob
    include JSON::Serializable
  ...
  class ServiceUpdate::Mode
    ...
    @[JSON::Field(key: "ReplicatedJob")]
    property! replicated_job : ServiceUpdate::Mode::ReplicatedJob?

    @[JSON::Field(key: "GlobalJob")]
    property! global_job : ServiceUpdate::Mode::GlobalJob?

    def initialize(@replicated : ServiceUpdate::Mode::Replicated? = nil, @global : ServiceUpdate::Mode::Global? = nil, @replicated_job : ServiceUpdate::Mode::ReplicatedJob? = nil, @global_job : ServiceUpdate::Mode::GlobalJob? = nil)
    end
  end
  ...
  class ServiceUpdate::Mode::GlobalJob
    include JSON::Serializable
  end
  ...
  class ServiceUpdate::Mode::ReplicatedJob
    include JSON::Serializable
  ...
  class SystemInfo
    ...
    @[JSON::Field(key: "CgroupVersion")]
    property! cgroup_version : String?
    ...
    @[JSON::Field(key: "DefaultAddressPools")]
    property! default_address_pools : Array(SystemInfo::DefaultAddressPools)?

    @[JSON::Field(key: "Warnings")]
    property! warnings : Array(String)?

    def initialize(@id : String? = nil, @containers : Int64? = nil, @containers_running : Int64? = nil, @containers_paused : Int64? = nil, @containers_stopped : Int64? = nil, @images : Int64? = nil, @driver : String? = nil, @driver_status : Array(Array(String))? = nil, @docker_root_dir : String? = nil, @plugins : PluginsInfo? = nil, @memory_limit : Bool? = nil, @swap_limit : Bool? = nil, @kernel_memory_tcp : Bool? = nil, @cpu_cfs_period : Bool? = nil, @cpu_cfs_quota : Bool? = nil, @cpu_shares : Bool? = nil, @cpu_set : Bool? = nil, @pids_limit : Bool? = nil, @oom_kill_disable : Bool? = nil, @ipv4_forwarding : Bool? = nil, @bridge_nf_iptables : Bool? = nil, @bridge_nf_ip6tables : Bool? = nil, @debug : Bool? = nil, @n_fd : Int64? = nil, @n_goroutines : Int64? = nil, @system_time : String? = nil, @logging_driver : String? = nil, @cgroup_driver : String? = nil, @cgroup_version : String? = nil, @n_events_listener : Int64? = nil, @kernel_version : String? = nil, @operating_system : String? = nil, @os_version : String? = nil, @os_type : String? = nil, @architecture : String? = nil, @ncpu : Int64? = nil, @mem_total : Int64? = nil, @index_server_address : String? = nil, @registry_config : RegistryServiceConfig? = nil, @generic_resources : GenericResources? = nil, @http_proxy : String? = nil, @https_proxy : String? = nil, @no_proxy : String? = nil, @name : String? = nil, @labels : Array(String)? = nil, @experimental_build : Bool? = nil, @server_version : String? = nil, @cluster_store : String? = nil, @cluster_advertise : String? = nil, @runtimes : Hash(String, Runtime)? = nil, @default_runtime : String? = nil, @swarm : SwarmInfo? = nil, @live_restore_enabled : Bool? = nil, @isolation : String? = nil, @init_binary : String? = nil, @containerd_commit : Commit? = nil, @runc_commit : Commit? = nil, @init_commit : Commit? = nil, @security_options : Array(String)? = nil, @product_license : String? = nil, @default_address_pools : Array(SystemInfo::DefaultAddressPools)? = nil, @warnings : Array(String)? = nil)
    end
  end

  class SystemInfo::DefaultAddressPools
    include JSON::Serializable
    ...
    def initialize(@base : String? = nil, @size : Int64? = nil)
    end
  end
  ...
  class TaskSpec::ContainerSpec::Ulimits
    include JSON::Serializable
  ...
  class TaskSpec::Resources
    ...
    property! limits : Limit?

    @[JSON::Field(key: "Reservations")]
    property! reservations : ResourceObject?

    def initialize(@limits : Limit? = nil, @reservations : ResourceObject? = nil)
    end
  end
  ...
  class Volume
    ...
    @[JSON::Field(key: "ClusterVolume")]
    property! cluster_volume : ClusterVolume?
    ...
    def initialize(@name : String, @driver : String, @mountpoint : String, @labels : Hash(String, String), @scope : String, @options : Hash(String, String), @created_at : Time? = nil, @status : Hash(String, JSON::Any)? = nil, @cluster_volume : ClusterVolume? = nil, @usage_data : Volume::UsageData? = nil)
    end
  end
  ...
  class VolumeCreateOptions
    ...
    @[JSON::Field(key: "ClusterVolumeSpec")]
    property! cluster_volume_spec : ClusterVolumeSpec?

    def initialize(@name : String, @driver : String, @driver_opts : Hash(String, String)? = nil, @labels : Hash(String, String)? = nil, @cluster_volume_spec : ClusterVolumeSpec? = nil)
    end
  end
  ...
  class VolumeUpdate
    ...
    def initialize(@spec : ClusterVolumeSpec? = nil)
    end
  end
  ...
  class Client
    def container_list(*, all : Bool? = nil, limit : Int64? = nil, size : Bool? = nil, filters : String? = nil) : Array(ContainerSummary)
      ...
      http_client.get("/v1.43/containers/json?#{query}") do |response|
    ...
    def container_create(body : ContainerCreate, *, name : String? = nil, platform : String? = nil) : ContainerCreateResponse
      query = Params.build do |qs|
        qs.add("name", name) unless name.nil?
        qs.add("platform", platform) unless platform.nil?
      end
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/containers/create?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 201
    ...
    def container_inspect?(id : String, *, size : Bool? = nil) : ContainerInspectResponse?
      ...
      http_client.get("/v1.43/containers/#{URI.encode_path_segment(id)}/json?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def container_top?(id : String, *, ps_args : String? = nil) : ContainerTopResponse?
      ...
      http_client.get("/v1.43/containers/#{URI.encode_path_segment(id)}/top?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def container_logs?(id : String, *, follow : Bool? = nil, stdout : Bool? = nil, stderr : Bool? = nil, since : Int64? = nil, _until : Int64? = nil, timestamps : Bool? = nil, tail : String? = nil) : Bytes?
      ...
      http_client.get("/v1.43/containers/#{URI.encode_path_segment(id)}/logs?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def container_changes?(id : String) : Array(FilesystemChange)?
      http_client.get("/v1.43/containers/#{URI.encode_path_segment(id)}/changes") do |response|
        case response.status_code
        when 200
          Array(FilesystemChange).from_json(response.body_io)
        when 404
        when 500
          raise ErrorResponse.from_json(response.body_io)
        else
    ...
    def container_export?(id : String) : Nil
      http_client.get("/v1.43/containers/#{URI.encode_path_segment(id)}/export") do |response|
        case response.status_code
        when 200, 404
        when 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_stats?(id : String, *, stream : Bool? = nil, one_shot : Bool? = nil) : JSON::Any?
      query = Params.build do |qs|
        qs.add("stream", stream) unless stream.nil?
        qs.add("one-shot", one_shot) unless one_shot.nil?
      end
      http_client.get("/v1.43/containers/#{URI.encode_path_segment(id)}/stats?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def container_resize(id : String, *, h : Int64? = nil, w : Int64? = nil) : Nil
      ...
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/resize?#{query}") do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_start(id : String, *, detach_keys : String? = nil) : Nil
      ...
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/start?#{query}") do |response|
        case response.status_code
        when 204, 304
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_stop(id : String, *, signal : String? = nil, t : Int64? = nil) : Nil
      query = Params.build do |qs|
        qs.add("signal", signal) unless signal.nil?
        qs.add("t", t) unless t.nil?
      end
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/stop?#{query}") do |response|
        case response.status_code
        when 204, 304
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_restart(id : String, *, signal : String? = nil, t : Int64? = nil) : Nil
      query = Params.build do |qs|
        qs.add("signal", signal) unless signal.nil?
        qs.add("t", t) unless t.nil?
      end
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/restart?#{query}") do |response|
        case response.status_code
        when 204
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_kill(id : String, *, signal : String? = nil) : Nil
      ...
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/kill?#{query}") do |response|
        case response.status_code
        when 204
        when 404, 409, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_update(id : String, update : ContainerUpdate) : ContainerUpdateResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/update", headers: headers, body: update.to_json) do |response|
        case response.status_code
        when 200
    ...
    def container_rename(id : String, *, name : String) : Nil
      ...
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/rename?#{query}") do |response|
        case response.status_code
        when 204
        when 404, 409, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_pause(id : String) : Nil
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/pause") do |response|
        case response.status_code
        when 204
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_unpause(id : String) : Nil
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/unpause") do |response|
        case response.status_code
        when 204
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_attach(id : String, *, detach_keys : String? = nil, logs : Bool? = nil, stream : Bool? = nil, stdin : Bool? = nil, stdout : Bool? = nil, stderr : Bool? = nil) : Nil
      ...
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/attach?#{query}") do |response|
        case response.status_code
        when 101, 200
        when 400, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_attach_websocket?(id : String, *, detach_keys : String? = nil, logs : Bool? = nil, stream : Bool? = nil, stdin : Bool? = nil, stdout : Bool? = nil, stderr : Bool? = nil) : Nil
      query = Params.build do |qs|
        qs.add("detachKeys", detach_keys) unless detach_keys.nil?
        qs.add("logs", logs) unless logs.nil?
        qs.add("stream", stream) unless stream.nil?
      ...
      http_client.get("/v1.43/containers/#{URI.encode_path_segment(id)}/attach/ws?#{query}") do |response|
        case response.status_code
        when 101, 200, 404
        when 400, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_wait(id : String, *, condition : String? = nil) : ContainerWaitResponse
      ...
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/wait?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def container_delete(id : String, *, v : Bool? = nil, force : Bool? = nil, link : Bool? = nil) : Nil
      ...
      http_client.delete("/v1.43/containers/#{URI.encode_path_segment(id)}?#{query}") do |response|
        case response.status_code
        when 204
        when 400, 404, 409, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_archive?(id : String, *, path : String) : Nil
      ...
      http_client.get("/v1.43/containers/#{URI.encode_path_segment(id)}/archive?#{query}") do |response|
        case response.status_code
        when 200, 404
        when 400, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def put_container_archive(id : String, input_stream : Bytes, *, path : String, no_overwrite_dir_non_dir : String? = nil, copy_uidgid : String? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.put("/v1.43/containers/#{URI.encode_path_segment(id)}/archive?#{query}", headers: headers, body: input_stream.to_json) do |response|
        case response.status_code
        when 200
    ...
    def container_archive_info(id : String, *, path : String) : Nil
      ...
      http_client.head("/v1.43/containers/#{URI.encode_path_segment(id)}/archive?#{query}") do |response|
        case response.status_code
        when 200
        when 400, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_prune(*, filters : String? = nil) : ContainerPruneResponse
      ...
      http_client.post("/v1.43/containers/prune?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_list(*, all : Bool? = nil, filters : String? = nil, shared_size : Bool? = nil, digests : Bool? = nil) : Array(ImageSummary)
      query = Params.build do |qs|
        qs.add("all", all) unless all.nil?
        qs.add("filters", filters) unless filters.nil?
        qs.add("shared-size", shared_size) unless shared_size.nil?
        qs.add("digests", digests) unless digests.nil?
      end
      http_client.get("/v1.43/images/json?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_build(input_stream : Bytes? = nil, *, dockerfile : String? = nil, t : String? = nil, extrahosts : String? = nil, remote : String? = nil, q : Bool? = nil, nocache : Bool? = nil, cachefrom : String? = nil, pull : String? = nil, rm : Bool? = nil, forcerm : Bool? = nil, memory : Int64? = nil, memswap : Int64? = nil, cpushares : Int64? = nil, cpusetcpus : String? = nil, cpuperiod : Int64? = nil, cpuquota : Int64? = nil, buildargs : String? = nil, shmsize : Int64? = nil, squash : Bool? = nil, labels : String? = nil, networkmode : String? = nil, platform : String? = nil, target : String? = nil, outputs : String? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/build?#{query}", headers: headers, body: input_stream.to_json) do |response|
        case response.status_code
        when 200
        when 400, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def build_prune(*, keep_storage : Int64? = nil, all : Bool? = nil, filters : String? = nil) : BuildPruneResponse
      ...
      http_client.post("/v1.43/build/prune?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_create(input_image : String? = nil, *, from_image : String? = nil, from_src : String? = nil, repo : String? = nil, tag : String? = nil, message : String? = nil, changes : Array(String)? = nil, platform : String? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/images/create?#{query}", headers: headers, body: input_image.to_json) do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def image_inspect?(name : String) : ImageInspect?
      http_client.get("/v1.43/images/#{URI.encode_path_segment(name)}/json") do |response|
        case response.status_code
        when 200
    ...
    def image_history?(name : String) : Array(HistoryResponseItem)?
      http_client.get("/v1.43/images/#{URI.encode_path_segment(name)}/history") do |response|
        case response.status_code
        when 200
    ...
    def image_push(name : String, *, tag : String? = nil) : Nil
      ...
      http_client.post("/v1.43/images/#{URI.encode_path_segment(name)}/push?#{query}") do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def image_tag(name : String, *, repo : String? = nil, tag : String? = nil) : Nil
      ...
      http_client.post("/v1.43/images/#{URI.encode_path_segment(name)}/tag?#{query}") do |response|
        case response.status_code
        when 201
        when 400, 404, 409, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def image_delete(name : String, *, force : Bool? = nil, noprune : Bool? = nil) : Array(ImageDeleteResponseItem)
      ...
      http_client.delete("/v1.43/images/#{URI.encode_path_segment(name)}?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_search(*, term : String, limit : Int64? = nil, filters : String? = nil) : Array(ImageSearchResponseItem)
      ...
      http_client.get("/v1.43/images/search?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_prune(*, filters : String? = nil) : ImagePruneResponse
      ...
      http_client.post("/v1.43/images/prune?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def system_auth(auth_config : AuthConfig? = nil) : SystemAuthResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/auth", headers: headers, body: auth_config.to_json) do |response|
        case response.status_code
        when 200
    ...
    def system_info() : SystemInfo
      http_client.get("/v1.43/info") do |response|
        case response.status_code
        when 200
    ...
    def system_version() : SystemVersion
      http_client.get("/v1.43/version") do |response|
        case response.status_code
        when 200
    ...
    def system_ping() : String
      http_client.get("/v1.43/_ping") do |response|
        case response.status_code
        when 200
    ...
    def system_ping_head() : String
      http_client.head("/v1.43/_ping") do |response|
        case response.status_code
        when 200
          String.from_json(response.body_io)
        when 500
    ...
    def image_commit(container_config : ContainerConfig? = nil, *, container : String? = nil, repo : String? = nil, tag : String? = nil, comment : String? = nil, author : String? = nil, pause : Bool? = nil, changes : String? = nil) : IdResponse
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/commit?#{query}", headers: headers, body: container_config.to_json) do |response|
        case response.status_code
        when 201
    ...
    def system_events(*, since : String? = nil, _until : String? = nil, filters : String? = nil) : EventMessage
      ...
      http_client.get("/v1.43/events?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def system_data_usage(*, type : Array(String)? = nil) : SystemDataUsageResponse
      query = Params.build do |qs|
        qs.add("type", type, "multi") unless type.nil?
      end
      http_client.get("/v1.43/system/df?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def image_get(name : String) : Bytes
      http_client.get("/v1.43/images/#{URI.encode_path_segment(name)}/get") do |response|
        case response.status_code
        when 200
          yield response.body_io
        when 500
    ...
    def image_get_all(*, names : Array(String)? = nil) : Bytes
      ...
      http_client.get("/v1.43/images/get?#{query}") do |response|
        case response.status_code
        when 200
          yield response.body_io
        when 500
    ...
    def image_load(images_tarball : Bytes? = nil, *, quiet : Bool? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/images/load?#{query}", headers: headers, body: images_tarball.to_json) do |response|
        case response.status_code
        when 200
        when 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def container_exec(id : String, exec_config : ExecConfig) : IdResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/containers/#{URI.encode_path_segment(id)}/exec", headers: headers, body: exec_config.to_json) do |response|
        case response.status_code
        when 201
          IdResponse.from_json(response.body_io)
        when 404, 409, 500
    ...
    def exec_start(id : String, exec_start_config : ExecStartConfig? = nil) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/exec/#{URI.encode_path_segment(id)}/start", headers: headers, body: exec_start_config.to_json) do |response|
        case response.status_code
        when 200
        when 404, 409
          raise ErrorResponse.from_json(response.body_io)
    ...
    def exec_resize(id : String, *, h : Int64? = nil, w : Int64? = nil) : Nil
      ...
      http_client.post("/v1.43/exec/#{URI.encode_path_segment(id)}/resize?#{query}") do |response|
        case response.status_code
        when 200
        when 400, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def exec_inspect?(id : String) : ExecInspectResponse?
      http_client.get("/v1.43/exec/#{URI.encode_path_segment(id)}/json") do |response|
        case response.status_code
        when 200
    ...
    def volume_list(*, filters : String? = nil) : VolumeListResponse
      ...
      http_client.get("/v1.43/volumes?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def volume_create(volume_config : VolumeCreateOptions) : Volume
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/volumes/create", headers: headers, body: volume_config.to_json) do |response|
        case response.status_code
        when 201
    ...
    def volume_inspect?(name : String) : Volume?
      http_client.get("/v1.43/volumes/#{URI.encode_path_segment(name)}") do |response|
        case response.status_code
        when 200
          Volume.from_json(response.body_io)
        when 404
    ...
    def volume_update(name : String, body : VolumeUpdate? = nil, *, version : Int64) : Nil
      query = Params.build do |qs|
        qs.add("version", version)
      end
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.put("/v1.43/volumes/#{URI.encode_path_segment(name)}?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
    ...
    def volume_delete(name : String, *, force : Bool? = nil) : Nil
      ...
      http_client.delete("/v1.43/volumes/#{URI.encode_path_segment(name)}?#{query}") do |response|
        case response.status_code
        when 204
        when 404, 409, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def volume_prune(*, filters : String? = nil) : VolumePruneResponse
      ...
      http_client.post("/v1.43/volumes/prune?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def network_list(*, filters : String? = nil) : Array(Network)
      ...
      http_client.get("/v1.43/networks?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def network_inspect?(id : String, *, verbose : Bool? = nil, scope : String? = nil) : Network?
      ...
      http_client.get("/v1.43/networks/#{URI.encode_path_segment(id)}?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def network_delete(id : String) : Nil
      http_client.delete("/v1.43/networks/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 204
        when 403, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def network_create(network_config : NetworkCreateRequest) : NetworkCreateResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/networks/create", headers: headers, body: network_config.to_json) do |response|
        case response.status_code
        when 201
    ...
    def network_connect(id : String, container : NetworkConnectRequest) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/networks/#{URI.encode_path_segment(id)}/connect", headers: headers, body: container.to_json) do |response|
        case response.status_code
        when 200
        when 403, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def network_disconnect(id : String, container : NetworkDisconnectRequest) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/networks/#{URI.encode_path_segment(id)}/disconnect", headers: headers, body: container.to_json) do |response|
        case response.status_code
        when 200
        when 403, 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def network_prune(*, filters : String? = nil) : NetworkPruneResponse
      ...
      http_client.post("/v1.43/networks/prune?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def plugin_list(*, filters : String? = nil) : Array(Plugin)
      ...
      http_client.get("/v1.43/plugins?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def get_plugin_privileges(*, remote : String) : Array(PluginPrivilege)
      ...
      http_client.get("/v1.43/plugins/privileges?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def plugin_pull(body : Array(PluginPrivilege)? = nil, *, remote : String, name : String? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/plugins/pull?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 204
        when 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_inspect?(name : String) : Plugin?
      http_client.get("/v1.43/plugins/#{URI.encode_path_segment(name)}/json") do |response|
        case response.status_code
        when 200
    ...
    def plugin_delete(name : String, *, force : Bool? = nil) : Plugin
      ...
      http_client.delete("/v1.43/plugins/#{URI.encode_path_segment(name)}?#{query}") do |response|
        case response.status_code
        when 200
          Plugin.from_json(response.body_io)
        when 404, 500
    ...
    def plugin_enable(name : String, *, timeout : Int64? = nil) : Nil
      ...
      http_client.post("/v1.43/plugins/#{URI.encode_path_segment(name)}/enable?#{query}") do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_disable(name : String) : Nil
      http_client.post("/v1.43/plugins/#{URI.encode_path_segment(name)}/disable") do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_upgrade(name : String, body : Array(PluginPrivilege)? = nil, *, remote : String) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/plugins/#{URI.encode_path_segment(name)}/upgrade?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 204
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_create(tar_context : Bytes? = nil, *, name : String) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/plugins/create?#{query}", headers: headers, body: tar_context.to_json) do |response|
        case response.status_code
        when 204
        when 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_push(name : String) : Nil
      http_client.post("/v1.43/plugins/#{URI.encode_path_segment(name)}/push") do |response|
        case response.status_code
        when 200
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def plugin_set(name : String, body : Array(String)? = nil) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/plugins/#{URI.encode_path_segment(name)}/set", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 204
        when 404, 500
          raise ErrorResponse.from_json(response.body_io)
    ...
    def node_list(*, filters : String? = nil) : Array(Node)
      ...
      http_client.get("/v1.43/nodes?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def node_inspect?(id : String) : Node?
      http_client.get("/v1.43/nodes/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 200
    ...
    def node_delete(id : String, *, force : Bool? = nil) : Nil
      ...
      http_client.delete("/v1.43/nodes/#{URI.encode_path_segment(id)}?#{query}") do |response|
        case response.status_code
        when 200
        when 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def node_update(id : String, body : NodeSpec? = nil, *, version : Int64) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/nodes/#{URI.encode_path_segment(id)}/update?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 400, 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def swarm_inspect?() : Swarm?
      http_client.get("/v1.43/swarm") do |response|
        case response.status_code
        when 200
    ...
    def swarm_init(body : SwarmInitRequest) : String
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/swarm/init", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
          String.from_json(response.body_io)
        when 400, 500, 503
    ...
    def swarm_join(body : SwarmJoinRequest) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/swarm/join", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 400, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def swarm_leave(*, force : Bool? = nil) : Nil
      ...
      http_client.post("/v1.43/swarm/leave?#{query}") do |response|
        case response.status_code
        when 200
        when 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def swarm_update(body : SwarmSpec, *, version : Int64, rotate_worker_token : Bool? = nil, rotate_manager_token : Bool? = nil, rotate_manager_unlock_key : Bool? = nil) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/swarm/update?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 400, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def swarm_unlockkey() : UnlockKeyResponse
      http_client.get("/v1.43/swarm/unlockkey") do |response|
        case response.status_code
        when 200
    ...
    def swarm_unlock(body : SwarmUnlockRequest) : Nil
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/swarm/unlock", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def service_list(*, filters : String? = nil, status : Bool? = nil) : Array(Service)
      query = Params.build do |qs|
        qs.add("filters", filters) unless filters.nil?
        qs.add("status", status) unless status.nil?
      end
      http_client.get("/v1.43/services?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def service_create(body : ServiceCreate) : ServiceCreateResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/services/create", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 201
    ...
    def service_inspect?(id : String, *, insert_defaults : Bool? = nil) : Service?
      ...
      http_client.get("/v1.43/services/#{URI.encode_path_segment(id)}?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def service_delete(id : String) : Nil
      http_client.delete("/v1.43/services/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 200
        when 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def service_update(id : String, body : ServiceUpdate, *, version : Int64, registry_auth_from : String? = nil, rollback : String? = nil) : ServiceUpdateResponse
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/services/#{URI.encode_path_segment(id)}/update?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
    ...
    def service_logs?(id : String, *, details : Bool? = nil, follow : Bool? = nil, stdout : Bool? = nil, stderr : Bool? = nil, since : Int64? = nil, timestamps : Bool? = nil, tail : String? = nil) : Bytes?
      ...
      http_client.get("/v1.43/services/#{URI.encode_path_segment(id)}/logs?#{query}") do |response|
        case response.status_code
        when 200
          yield response.body_io
        when 404
    ...
    def task_list(*, filters : String? = nil) : Array(Task)
      ...
      http_client.get("/v1.43/tasks?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def task_inspect?(id : String) : Task?
      http_client.get("/v1.43/tasks/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 200
    ...
    def task_logs?(id : String, *, details : Bool? = nil, follow : Bool? = nil, stdout : Bool? = nil, stderr : Bool? = nil, since : Int64? = nil, timestamps : Bool? = nil, tail : String? = nil) : Bytes?
      ...
      http_client.get("/v1.43/tasks/#{URI.encode_path_segment(id)}/logs?#{query}") do |response|
        case response.status_code
        when 200
          yield response.body_io
        when 404
    ...
    def secret_list(*, filters : String? = nil) : Array(Secret)
      ...
      http_client.get("/v1.43/secrets?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def secret_create(body : SecretCreate? = nil) : IdResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/secrets/create", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 201
          IdResponse.from_json(response.body_io)
        when 409, 500, 503
    ...
    def secret_inspect?(id : String) : Secret?
      http_client.get("/v1.43/secrets/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 200
    ...
    def secret_delete(id : String) : Nil
      http_client.delete("/v1.43/secrets/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 204
        when 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def secret_update(id : String, body : SecretSpec? = nil, *, version : Int64) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/secrets/#{URI.encode_path_segment(id)}/update?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 400, 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def config_list(*, filters : String? = nil) : Array(Config)
      ...
      http_client.get("/v1.43/configs?#{query}") do |response|
        case response.status_code
        when 200
    ...
    def config_create(body : ConfigCreate? = nil) : IdResponse
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/configs/create", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 201
          IdResponse.from_json(response.body_io)
        when 409, 500, 503
    ...
    def config_inspect?(id : String) : Config?
      http_client.get("/v1.43/configs/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 200
    ...
    def config_delete(id : String) : Nil
      http_client.delete("/v1.43/configs/#{URI.encode_path_segment(id)}") do |response|
        case response.status_code
        when 204
        when 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def config_update(id : String, body : ConfigSpec? = nil, *, version : Int64) : Nil
      ...
      headers = HTTP::Headers{"Content-Type" => "application/json"}
      http_client.post("/v1.43/configs/#{URI.encode_path_segment(id)}/update?#{query}", headers: headers, body: body.to_json) do |response|
        case response.status_code
        when 200
        when 400, 404, 500, 503
          raise ErrorResponse.from_json(response.body_io)
    ...
    def distribution_inspect(name : String) : DistributionInspect
      http_client.get("/v1.43/distribution/#{URI.encode_path_segment(name)}/json") do |response|
        case response.status_code
        when 200
    ...
    def session() : Nil
      http_client.post("/v1.43/session") do |response|
        case response.status_code
        when 101
        when 400, 500
          raise ErrorResponse.from_json(response.body_io)
